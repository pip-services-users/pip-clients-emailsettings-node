# Development and Testing Guide <br/> Email Settings Microservice Client SDK for Node.ks
...
```bash
git clone git@github.com:pip-services-users/pip-clients-emailsettings-node.git
```
